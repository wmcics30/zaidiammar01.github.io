...
function runSimulation(){
  if (carArray.length < 1){
	let car1 = new Car(400, 260, 2, random(255), 15, random(27, 34));
	carArray.push(car1);
	let car2 = new Car(0, 210, 4, random(255), 15, random(27, 34));
	carArray.push(car2);
	let car3 = new Car(900, 260, 2, random(255), 15, random(27, 34));
	carArray.push(car3);
	let car4 = new Car(400, 510, 4, random(255), 15, random(27, 34));
	carArray.push(car4);
	let car5 = new Car(0, 530, 2, random(255), 15, random(27, 34));
	carArray.push(car5);
	let car6 = new Car(900, 530, 2, random(255), 15, random(27, 34));
	carArray.push(car6);
  }
